...
BuildRequires: smartmet-library-textgen-devel >= 26.9.21-8
...
Requires: smartmet-library-textgen >= 26.9.21-8
Requires: zlib
%if 0%{rhel} >= 8
...
%changelog
* Wed Sep 23 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> - 26.9.21-3.fmi
- Marine sea regression results and test dictionaries for smartmet-library-textgen 26.9.21-8: a change and its turn are reported when they start
